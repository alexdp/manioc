 ...
 * 
 * Version 0.0.4 (06-30-2014) : <br/>
 * + supports to delegate bean finalization by calling BeanFactory.delegatesBeanFinalization(true). Useful on webapp restart.
 * 
		...
		public void inject(Object o, Class<? extends DefaultApplicationContext> context) {
			...
			for (Class<?> aClass : classAndSuperClasses) {
				...
				for (Field aField : aClass.getDeclaredFields()) {
					Inject propertyAnnotation = aField.getAnnotation(Inject.class);
